...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ...
                        ('Jane_Webster', 
                         ...
                         'Jane', 'Webster', 'super_admin', -1, 'Jane@gmail.com', 0, 0
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ) VALUES 
                        ('Emma_Wong', 
                         ...
                         'Emma', 'Wong', 'admin', 1, 'Emma_Wong@gmail.com', 0, 0
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ) VALUES 
                        ('Bob_Brown', 
...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ) VALUES 
                        ('Holy_Roller', 
                         ...
                         'Holy', 'Roller', 'user', 1, 'Holy_Roller@gmail.com', 2, 2, 1,
                         0, 0, 0, 19, 20, 21
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                        ...
                        ('Fredie_Fender', 
                         ...
                         'Fredie', 'Fender', 'user', 1, 'Fredie_Fender@yahoo.com', 1, 1, 1,
                         0, 0, 0, 37, 5, 15
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                        ...
                        ('New_User1', 
                         SHA2('New_User1', 512), 
                         'New', 'User1', 'user', 2, 'New_User1@yahoo.com', 4, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User2', 
                         SHA2('New_User2', 512), 
                         'New', 'User2', 'user', 3, 'New_User2@yahoo.com', 0, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User3', 
                         SHA2('New_User3', 512), 
                         'New', 'User3', 'user', 1, 'New_User3@yahoo.com', 5, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User4', 
                         SHA2('New_User4', 512), 
                         'New', 'User4', 'user', 4, 'New_User4@yahoo.com', 0, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User5', 
                         SHA2('New_User5', 512), 
                         'New', 'User5', 'user', 4, 'New_User5@yahoo.com', 6, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User6', 
                         SHA2('New_User6', 512), 
                         'New', 'User6', 'user', 1, 'New_User6@yahoo.com', 7, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User7', 
                         SHA2('New_User7', 512), 
                         'New', 'User7', 'user', 1, 'New_User7@yahoo.com', 8, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup, currentPhase,
                         entriesNumPhase, postsNumPhase, likesNumPhase, entriesNumTotal, postsNumTotal, likesNumTotal
                        ...
                        ('New_User8', 
                         SHA2('New_User8', 512), 
                         'New', 'User8', 'user', 1, 'New_User8@yahoo.com', 9, 1, 1,
                         0, 0, 0, 9, 29, 39
                         );
