...
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ...
                        ('admin', 
                         ...
                         'Jane', 'Webster', 'super_admin', -1, 'admin@gmail.com', 0, 0
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ) VALUES 
                        ('SuperAdmin2', 
                         'ce35c65a1bda9ed7295703649de86b3875fc72aca7ef35f16c4118badb9a928ecc4a0099bdbba9d23134bcc79e53d0c8e22870940b35f0c8d5cb2e7dd728cb94', 
                         'Super', 'Admin2', 'super_admin', -1, 'superAdmin2@gmail.com', 0, 0
                         );
INSERT INTO `userTable` (userName, encodedPW, firstName, lastName, privilegeLevel, adminID, email, studyID, currentConditionGroup
                        ) VALUES 
                        ('Emma_Wong', 
